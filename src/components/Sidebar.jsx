import { LayoutDashboard, Phone, Settings, FileText, LogOut, ShieldCheck, User } from 'lucide-react';
...
export function Sidebar() {
  ...
  // Verifica se é chefe (Admin ou Supervisor)
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        {isManager && (
            <div className="pt-4 mt-4 border-t border-slate-100">
                <p className="px-4 text-xs font-bold text-slate-400 uppercase mb-2">Administração</p>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50">
        <div className="flex items-center gap-3 mb-3 px-2">
            <div className={`w-9 h-9 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-sm
                ${isManager ? 'bg-indigo-600' : 'bg-blue-500'}`}>
