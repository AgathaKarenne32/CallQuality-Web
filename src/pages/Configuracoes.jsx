...
export function Configuracoes() {
    ...
    // Estado para o formulário de novo critério
    ...
    const handleSalvar = async (e) => {
        ...
        try {
            ...
            setNovoCriterio({ descricao: '', instrucaoIa: '', peso: 1 }); // Limpa form
            setIsFormOpen(false); // Fecha form
            carregarCriterios(); // Recarrega lista
        } catch (error) {
